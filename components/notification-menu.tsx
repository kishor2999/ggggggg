...
export function NotificationMenu() {
    ...
    useEffect(() => {
        ...
        // No longer subscribing to dbUserChannel to avoid duplicate notifications
        ...
        const handleNewNotification = (notification: Notification) => {
            ...
            toast.info(notification.title, {
                ...
                duration: 5000,
                id: `notification-${notification.id}` // Use a unique ID based on notification ID
            });
        };
        ...
        // Set up periodic polling for notifications to ensure UI is up-to-date
